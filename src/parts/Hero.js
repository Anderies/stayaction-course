...
import IconTreasures from '../assets/images/icons/icontraveler.svg'
import IconCities from '../assets/images/icons/icontraveler.svg'
import ImageHero from '../assets/images/icons/icontraveler.svg'
        ...
        <section className="container pt-4">
            <div className="row align-items-center">
                ...
                <div className="row mt-5">
                    ...
                    <div className="col-auto" style={{ marginRight: 35 }}>
                        <img width="36" height="36" src={IconTreasures} alt={`${props.data.treasures} Treasures`}></img>
                        <h6 className="mt-3">
